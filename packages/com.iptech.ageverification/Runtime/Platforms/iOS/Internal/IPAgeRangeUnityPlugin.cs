...
namespace IPTech.AgeVerification.iOS.Internal
{
    ...
    internal static class IPAgeRangeUnityPlugin
    {
        ...
        private static extern bool IPAgeRangeUnityPlugin_isEligibleForAgeFeatures(int callerId, IsEligibleForAgeFeaturesCallback callback);
        ...
        public static async Task<bool> IsEligibleForAgeFeatures(CancellationToken ct)
        {
            ...
            try 
            {
                ...
                {
                    IPAgeRangeUnityPlugin_isEligibleForAgeFeatures(callerId, HandleIsEligibleForAgeFeaturesCallback);
