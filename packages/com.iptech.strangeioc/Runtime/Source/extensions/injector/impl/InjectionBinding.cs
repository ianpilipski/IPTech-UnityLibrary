	...
	public class InjectionBinding : Binding, IInjectionBinding
	{
		...
		public IInjectionBinding SetValue(object o)
		{
			...
			for (int a = 0; a < aa; a++)
			{
				...
				{
					throw new InjectionException("Injection cannot bind a value that does not extend or implement the binding type. " + keyType.ToString(), InjectionExceptionType.ILLEGAL_BINDING_VALUE);
				}
			}
			To(o);
			return this;
