...
namespace IPTech.UnityServices {
    public class AdsManager
    {
        ...
        void HandleConsentValueChanged(EConsentValue consentValue) {
            if(consentValue == EConsentValue.Unknown) return;
            if(initialized) {
                //#error implment

            } else {
                if(consentValue == EConsentValue.Accepted) {
