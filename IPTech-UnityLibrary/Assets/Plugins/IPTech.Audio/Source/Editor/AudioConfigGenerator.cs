...
namespace IPTech.Audio.EditorExtensions {
    ...
    public partial class AudioConfigGenerator : AudioConfigGeneratorBase {
        ...
        public virtual string TransformText() {
            ...
            #line 11 ""
            this.Write("(AudioEngine audioEngine, AudioEngineConfig config) {\n            this.audioEngin" +
                    "e = audioEngine;\n            this.config = config;\n        }\n\n        ");
 ...
 for(int i=0;i<config.AudioClips.Count;i++) { AudioClipsCollection acc = config.AudioClips[i]; 
            ...
            #line 17 ""
            this.Write("        public AudioHandle Play");
            
            #line default
            #line hidden
            
            #line 17 ""
            this.Write(this.ToStringHelper.ToStringWithCulture( MakeSafeCodeName(acc.name) ));
            
            #line default
            #line hidden
            
            #line 17 ""
            this.Write("(bool looping=false) {\n            return audioEngine.Play(config.AudioClips[");
