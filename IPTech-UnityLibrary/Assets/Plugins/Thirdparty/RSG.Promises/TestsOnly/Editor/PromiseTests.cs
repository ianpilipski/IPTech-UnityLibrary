...
namespace RSG.Tests
{
    public class PromiseTests
    {
        ...
        public void combined_promise_of_three_types_is_resolved_when_children_are_resolved()
        {
			...
			Promise<bool> promise2 = new Promise<bool>();
			Promise<float> promise3 = new Promise<float>();

			IPromise<Tuple<int,bool,float>> all = PromiseHelpers.All<int,bool,float>(promise1, promise2, promise3);
