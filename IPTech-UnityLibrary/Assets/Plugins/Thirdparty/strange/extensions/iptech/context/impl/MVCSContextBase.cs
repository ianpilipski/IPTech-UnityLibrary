...
{
	public class MVCSContextBase : CrossContext
	{
		...
		public MVCSContextBase(object view) : base(view)
		{
		}

		public MVCSContextBase(object view, ContextStartupFlags flags) : base(view, flags)
		{
		}

		public MVCSContextBase(object view, bool autoMapping) : base(view, autoMapping)
		{
		}
		...
		protected override void addCoreComponents()
		{
			...
			injectionBinder.Bind<IContextViewAdapter>().To<ContextViewAdapter>().ToSingleton();
		}
		
		protected override void instantiateCoreComponents()
		{
			base.instantiateCoreComponents();
			contextViewAdapter = injectionBinder.GetInstance<IContextViewAdapter>() as IContextViewAdapter;
			contextViewAdapter.BindContextViewAdapter(contextView, injectionBinder);
		...
		protected override void postBindings()
		{
			...
			mediationBinder.Trigger(MediationEvent.AWAKE, contextViewAdapter.GetIViewFromContextView(contextView));
		}
		...
		virtual protected void cacheView(object view)
		{
